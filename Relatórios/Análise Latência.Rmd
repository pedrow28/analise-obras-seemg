...
Para análise das informações, foi realizado o download da mesma, diretamente via GoogleDrive, e tratamento de sua estrutura. Esse procedimento foi realizado em script próprio e a base de dados foi salva como o objeto "relacao_termos.rds". Tal objeto será lido e convertido como o item "obras".
